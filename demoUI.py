...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.originalIndexEdit.setValidator(QIntValidator(0, 299))
        self.originalIndexEdit.setMaxLength(4)
    ...
    def retranslateUi(self, Form):
        ...
        self.Author.setText(_translate("Form", "陳柏廷, 楊承翰, 鄭惟, 王傑世, 謝宜紘, 許龍君"))
